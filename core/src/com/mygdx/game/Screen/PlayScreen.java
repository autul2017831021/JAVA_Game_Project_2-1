...
import com.mygdx.game.Sprites.Wizard;
...
public class PlayScreen implements Screen {
    ...
    public void handleInput(float dt){
        ...
        /*if(Gdx.input.isKeyJustPressed(Input.Keys.UP))
        {
            ...
            player1.b3body.applyLinearImpulse(new Vector2(0,4f),player.b2body.getWorldCenter(),true);
        }*/
        if(Gdx.input.isKeyPressed(Input.Keys.RIGHT) && player.b2body.getLinearVelocity().x <=2)
        {
            //player.b2body.applyLinearImpulse(new Vector2(0.1f,0),player.b2body.getWorldCenter(),true);
            player1.b3body.applyLinearImpulse(new Vector2(0.1f,0),player.b2body.getWorldCenter(),true);
        }
